...
# within /49-2/AerodromePresentWeather and /49-2/AerodromeForecastWeather registers 
# based on list provided by ICAO AMOFSG/10
# @//src/weather-codes/present-weather-codes-ww.txt and
# @//src/weather-codes/forecast-weather-codes-ww.txt
#
# example string: 
...
#            a reg:RegisterItem ;
#            reg:definition
#                [ reg:entity <http://codes.wmo.int/306/4678/DZ> ] ;
#            reg:status reg:statusStable ;
#            reg:notation "DZ" ;
#            .
#        <http://codes.wmo.int/306/4678/DZ>
#            a skos:Concept ;
#            rdfs:label "Precipitation of drizzle"@en ;
#            .
#
...
def main(argv): 
    usage= 'usage: present+forecast_weather_registerItem_generator_49-2.py -i <inputfile>'+'\r\n'
    inputFileName = ''
...
# wite prefix statements
        ...
        for line in infile: 
            ...
            if list:
                ...
                sys.stdout.write('        [ reg:entity <http://codes.wmo.int/306/4678/'+code+'> ] ;\n')
                sys.stdout.write('    reg:status reg:statusStable ;\n')
                sys.stdout.write('    reg:notation "'+code+'" ;\n')
                sys.stdout.write('.\n')
                sys.stdout.write('<http://codes.wmo.int/306/4678/'+code+'>\n')
