...
# utility tool for automatically generating concept and associated registerItem RDF 
# (in TTL format) for terms within /306/4678 register based on list provided by ICAO AMOFSG/10
# @//src/weather-codes/weather-codes-ww-complete-set.txt
#
# example string: 
#        '+TSRA,"Thunderstorm with heavy precipitation rain"'
# example RDF:
#        []
#            a reg:RegisterItem ;
#            reg:definition
...
#        <+TSRA>
#            a skos:Concept ;
#            rdfs:label "Thunderstorm with heavy precipitation rain"@en ;
#            .
#
...
def main(argv): 
    usage= 'usage: present_weather_concept_generator_306_4678.py -i <inputfile>'+'\r\n'
    inputFileName = ''
...
# wite prefix statements
        ...
        for line in infile: 
            ...
            if list:
                ...
                sys.stdout.write('        [ reg:entity <'+code+'> ] ;\n')
